...
pub const TOPICS: &[(&str, &str)] = &[
    ...
    ("Ctrl-W w W", "focus the next / previous window"),
    ("Ctrl-W hjkl", "focus the window in that direction"),
    ("Ctrl-W c", "close this window (also :close, or :q)"),
    ("Ctrl-W o", "close every other window (also :only)"),
    ("", ""),
    ("FINDING THINGS", ""),
    ...
    (
        ":grep {pattern}",
        "search the project; Enter jumps to a hit",
    ),
    (":buffers", "pick from the open buffers"),
    (
        "Ctrl-W e",
        "show or hide the file explorer (also :explorer)",
    ),
    ("Ctrl-W E", "move the keyboard to the explorer and back"),
    (
        "in a picker",
        "type to filter · Ctrl-N/P or arrows · Enter · Esc",
    ),
    ("", ""),
